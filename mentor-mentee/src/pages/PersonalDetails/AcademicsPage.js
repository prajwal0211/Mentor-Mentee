...
const AcademicsPage = () => {
    ...
    return (
      ...
      <Table striped bordered hover className="mt-3" style={tableStyle1}>
        <thead>
          <tr>
            ...
            <th style={headerCellStyle1}><b>Percentage</b></th>
            <th style={headerCellStyle1}><b>Medium</b></th>
            <th style={headerCellStyle1}><b>Board</b></th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <th style={headerCellStyle1}><b>S.S.C</b></th>
            <td style={dataCellStyle}><input
              type="text"
          ...
          <tr>
            <th style={headerCellStyle1}><b>H.S.C</b></th>
            <td style={dataCellStyle}><input
              type="text"
      ...
      <Table striped bordered hover className="mt-5" style={tableStyle2}>
        <thead>
          <tr>
            <th style={headerCellStyle2}><b></b></th>
            <th style={headerCellStyle2}><b>CET/AIEEE</b></th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <th style={headerCellStyle2}><b>Score</b></th>
            <td style={dataCellStyle}><input
          type="text"
        ...
        /></td>
          ...
          <tr>
            <th style={headerCellStyle2}><b>Rank</b></th>
            <td style={dataCellStyle}><input
          type="text"
          value={data.cet.rank}
